...
class VectorPreferenceSystem(BasePreferenceSystem):
    ...
    def _generate_similar_vector(self, base_vector: np.ndarray, 
        ...
        Uses the exact same approach as generate_vectors_with_cosine_similarity.py
        which correctly handles all similarity values.
        """
        ...
        random_vec = self.rng.randn(length)
        ...
        # Scale v2 to have random magnitude (matching generate_vectors_with_cosine_similarity.py)
        v2 = v2_norm * self.rng.uniform(1, 10)
