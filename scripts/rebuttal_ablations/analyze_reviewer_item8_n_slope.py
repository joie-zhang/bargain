...
Usage
-----
    python scripts/rebuttal_ablations/analyze_reviewer_item8_n_slope.py
    python scripts/rebuttal_ablations/analyze_reviewer_item8_n_slope.py --bootstrap-reps 5000
