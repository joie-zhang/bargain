...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  --conservative  Model-scale sweep: 30 pairs, 3x3 alpha/sigma grid, both orders (540 configs)"
            echo "  --ambitious     Model-scale sweep: 30 pairs, 5x5 alpha/sigma grid, 3 runs, both orders (4500 configs)"
