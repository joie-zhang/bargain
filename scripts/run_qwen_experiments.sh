...
# Step 6: Run Initial Experiment Suite (3 Models)
# Each model: 5 runs with competition_level=0
...
echo "============================================================"
echo "QWEN2.5 EXPERIMENTS - BATCH RUN"
echo "============================================================"
...
echo "  *Qwen2.5-*B-Instruct_vs_${ADVERSARY_MODEL}*"
echo ""
