...
A complementary observation comes from \emph{zero-cost collaboration} settings explicitly designed to remove strategic conflict: \citet{yadav_more_2026} show that the more capable OpenAI o3 reaches only $17\%$ of optimal group performance, whereas the less capable o3-mini attains $50\%$ under identical instructions, with explicit coordination protocols and small monetary incentives closing much of the gap.
These findings are closely related to our own concern that general-purpose capability does not map monotonically onto strategic performance, and that cooperative behavior in particular may require deliberate scaffolding rather than emerging from raw capability alone.
