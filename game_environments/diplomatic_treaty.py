...
class DiplomaticTreatyGame(GameEnvironment):
    ...
    ISSUE_NAMES = [
        ...
        "Pandemic medical countermeasure allocation",
        "Virgin plastic production reduction",
        "Frontier AI safety evaluation sharing",
        "Genetic resource commercial use benefit-sharing",
        "Nuclear warhead reduction",
        "Climate finance contribution level",
        "Carbon cost on imports",
        "Autonomous weapons human-control requirement",
        "AI chip export quota",
        "Solar geoengineering outdoor research restriction",
        "Critical infrastructure cyber-attack prohibition coverage",
        "Refugee resettlement burden share",
        "Commercial spyware export control",
        "Global minimum corporate tax coverage",
        "Critical mineral emergency stockpile contribution",
        "Shipping emissions reduction target",
        "Biodiversity finance contribution",
        "Sovereign debt climate-shock pause clause coverage",
        "Staple food export restriction limit",
        "Anti-satellite weapons testing restriction",
    ...
    ISSUE_PROPOSITIONS = [
        ...
        "0% = no reserved share of vaccines, diagnostics, and therapeutics for the accord's pooled allocation mechanism | 100% = the full agreed share of vaccines, diagnostics, and therapeutics reserved for the accord's pooled allocation mechanism",
        "0% = no cap on virgin plastic polymer production | 100% = full phase-down to the accord's maximum agreed reduction target for virgin plastic polymer production",
        "0% = no cross-border disclosure of safety evaluations or incident reports for covered frontier AI models | 100% = full pre-deployment safety evaluation results and post-deployment incident reports shared for all covered frontier AI models",
        "0% = no benefit-sharing payment required for commercial use of genetic sequence data from covered genetic resources | 100% = full agreed levy/benefit-sharing payment required on all covered commercial uses of genetic sequence data, with proceeds routed to the accord's biodiversity benefit-sharing fund",
        "0% = no warheads eliminated | 100% = complete multilateral nuclear disarmament",
        "0% = no contribution to the accord's climate finance pool | 100% = each party contributes its full assessed amount to the accord's climate finance target",
        "0% = no carbon cost on covered imports | 100% = full domestic carbon price applied to covered imports",
        "0% = no requirement for human authorization in target engagement by covered autonomous weapon systems | 100% = positive human authorization required for target engagement by all covered autonomous weapon systems",
        "0% = total ban on H200-class AI chip exports | 100% = unrestricted export of all advanced AI chips",
        "0% = outdoor solar geoengineering experiments permitted under domestic approval only | 100% = all outdoor solar geoengineering experiments prohibited or subject to mandatory accord-level licensing",
        "0% = no critical infrastructure categories covered by a binding state-sponsored cyber non-targeting commitment | 100% = all designated critical infrastructure categories covered by a binding state-sponsored cyber non-targeting commitment with mandatory incident notification",
        "0% = no resettlement commitment under the accord's capacity-based formula | 100% = each party meets its full assessed resettlement quota under the accord's capacity-based formula",
        "0% = no export licensing or restriction on covered commercial spyware | 100% = full prohibition on export of covered commercial spyware except under the accord's strictest licensing and human-rights screening regime",
        "0% = no covered multinationals subject to the accord's minimum corporate tax floor | 100% = all covered multinationals subject to the accord's minimum corporate tax floor with no major carve-outs",
        ...
        "0% = no contribution to the accord's biodiversity finance target | 100% = each party contributes its full assessed amount to the accord's biodiversity finance target",
        "0% = no covered sovereign debt instruments required to include a disaster/climate-shock pause clause | 100% = all covered sovereign debt instruments required to include the accord's binding disaster/climate-shock pause clause",
        "0% = no limit on covered staple-food export restrictions during food shocks | 100% = full prohibition on covered staple-food export restrictions during food shocks except under narrow accord-defined emergency carve-outs",
        "0% = no orbital altitude bands subject to a debris-creating ASAT test prohibition | 100% = all orbital altitude bands subject to a binding debris-creating ASAT test prohibition (altitude bands here means LEO, MEO, GEO, and beyond-GEO orbital regions)",
    ...
    ISSUE_INTERP_TEMPLATES = [
        ...
        "{pct}% of the agreed pandemic countermeasure share reserved for the accord's pooled allocation mechanism",
        "{pct}% of the accord's maximum virgin plastic polymer production reduction target adopted",
        "{pct}% of covered frontier AI models subject to mandatory pre-deployment safety evaluation and incident-sharing disclosure",
        "{pct}% of covered commercial uses of genetic sequence data subject to the accord's mandatory benefit-sharing levy",
        "{pct}% of multilateral nuclear warheads eliminated",
        "{pct}% of each party's assessed contribution committed to the accord's climate finance target",
        "{pct}% of the domestic carbon price applied to covered imports",
        "{pct}% of covered autonomous weapon systems required to obtain positive human authorization for target engagement",
        "{pct}% of advanced AI chip production cleared for export",
        "{pct}% of outdoor solar geoengineering experiments subject to mandatory accord-level licensing or prohibition",
        ...
        "{pct}% of each party's assessed resettlement quota committed under the accord's capacity-based formula",
        "{pct}% of covered commercial spyware exports subject to the accord's mandatory licensing and human-rights screening regime",
        "{pct}% of covered multinationals subject to the accord's minimum corporate tax floor",
        ...
        "{pct}% of each party's assessed contribution committed to the accord's biodiversity finance target",
        "{pct}% of covered sovereign debt instruments required to include a binding disaster/climate-shock pause clause",
        "{pct}% of covered staple-food categories subject to the accord's prohibition on export restrictions during food shocks",
        "{pct}% of orbital altitude bands (LEO, MEO, GEO, and beyond-GEO) subject to a binding debris-creating ASAT test prohibition",
